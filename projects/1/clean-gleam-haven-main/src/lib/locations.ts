...
export const ankaraDistricts: District[] = [
  "Çankaya","Çayyolu","Ümitköy","Yaşamkent","Beysukent","Konutkent","Mutlukent",
  "İncek","Gölbaşı","Oran","Kavaklıdere","Gaziosmanpaşa","Bahçelievler",
  "Yenimahalle","Keçiören","Etimesgut","Eryaman","Pursaklar","Mamak","Sincan",
  "Altındağ","Polatlı","Beypazarı",
].map((n) => ({
  slug: slugify(n),
  name: n,
  city: "ankara",
...
export const antalyaDistricts: District[] = [
  "Konyaaltı","Lara","Muratpaşa","Kepez","Döşemealtı","Aksu","Belek","Kundu",
  "Kemer","Göynük","Tekirova","Beldibi","Side","Manavgat","Alanya","Kaş",
  "Kalkan","Demre","Finike","Kumluca","Serik",
].map((n) => ({
  slug: slugify(n),
  name: n,
  city: "antalya",
