...
export function PriceCalculator() {
  ...
  const quote = useMemo(() => calculateQuote({ service, m2, soil, access }), [service, m2, soil, access]);
  ...
  return (
    <section id="fiyat" className="relative py-24">
      <div className="container mx-auto px-4">
        <SectionHeader
          eyebrow="Anında Fiyat"
          title="3 saniyede tahmini bütçenizi öğrenin"
          desc="Hizmet tipine göre gerçek zamanlı hesaplama. Detaylı keşif sonrası net fiyat WhatsApp üzerinden iletilir."
        />
