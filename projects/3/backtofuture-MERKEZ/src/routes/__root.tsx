...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "Bakım Temizlik Restorasyon Pergola | BioClimatic | Tente | Zip Perde" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "Bakım Temizlik Restorasyon Pergola | BioClimatic | Tente | Zip Perde" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Lovable App" },
      { name: "twitter:description", content: "Bakım Temizlik Restorasyon Pergola | BioClimatic | Tente | Zip Perde" },
