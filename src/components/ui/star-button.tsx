...
export function StarButton({
  ...
  duration = 3,
  lightColor = "#FAFAFA",
  backgroundColor = "#000080", // default dark navy per user request
  borderWidth = 2,
  className,
  ...props
}: StarButtonProps) {
  ...
  return (
    <button
      ...
      ref={pathRef}
      className={cn(
        "relative z-[3] overflow-hidden h-12 px-8 py-3 inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-3xl text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 group/star-button",
        className,
      )}
      {...props}
    >
      ...
      <span className="z-10 relative bg-gradient-to-t from-white to-neutral-200 inline-block text-transparent bg-clip-text text-base font-semibold">
        {children}
      </span>
    </button>
  );
